...
class FollowUpChatsButton extends StatelessWidget {
  final List<FollowUpChatSummary> chats;
  final VoidCallback? onRefresh;

  const FollowUpChatsButton({
    super.key,
    required this.chats,
    this.onRefresh,
  });
  ...
  void _showChatsModal(BuildContext context) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => _FollowUpChatsModal(
        chats: chats,
        onRefresh: onRefresh,
      ),
    );
